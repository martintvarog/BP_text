...
%  		\bibitem{struktura-bloku}\it{NAME_OF_AUTHOR. NAME_OF_ARTICLE. NAME_OF_WEBSITE [online]. 16 Nov, 2022} [online]. [cit.2024-01-19]. Dostupný z~WWW:\url{https://www.geeksforgeeks.org/blockchain-structure/}
	...
	\bibitem{Konsensus}\it{Konsensus} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://academy.binance.com/en/articles/what-is-a-blockchain-consensus-algorithm}
	
	

	
	\bibitem{DApps}\it{DApps} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://www.algorand.foundation/news/what-is-a-dapp-decentralized-apps-explained}
	
	\bibitem{Web2VsWeb3}\it{Web2VsWeb3} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://medium.com/geekculture/web2-vs-web3-understanding-the-evolution-of-the-internet-8162548ec94d}
	
	
	
	\bibitem{Smart-contract}\it{Smart-contract} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://www.spiceworks.com/tech/innovation/articles/what-are-smart-contracts/}
	
	\bibitem{Ethereum-Identity}\it{Ethereum Identity} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://ethereum.org/en/decentralized-identity/\#benefits-of-decentralized-identity}
	
	
	\bibitem{EAS:Intro}\it{Intro to EAS} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://docs.attest.org/docs/welcome}
	
	\bibitem{EAS:Pyramid}\it{Pyramida Užití EAS} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://docs.attest.org/docs/purpose/attestation-ecosystem}
	
	
	
	\bibitem{EAS:Atestace}\it{EAS:Atestace} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://docs.attest.org/docs/core--concepts/attestations}
	
	\bibitem{EAS:Schema}\it{EAS:Schema} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://docs.attest.org/docs/core--concepts/schemas}
	
	
	\bibitem{EAS:OnChainVsOffChain}\it{EAS:OnChainVsOffChain} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://docs.attest.org/docs/core--concepts/onchain-vs-offchain}
	
	
	
	\bibitem{CeskaPosta}\it{CeskaPosta} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://www.postsignum.cz/certifikaty.html}
	
	
	\bibitem{Certoo}\it{Certoo} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://certoo.eu/}
	
	
	\bibitem{P2P site}\it{P2P} [online]. [cit.2024-03-19]. Dostupný z~WWW:\url{https://www.spiceworks.com/tech/networking/articles/what-is-peer-to-peer/}
