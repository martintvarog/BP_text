...
\n{2}{Principy}
Jedinečnost a krása blockchainu je v jejím distrubovaném přístupu bez nutnosti centralní entity a neměnnosti, která díky samotné nátuře znemožnuje podvody. 
\n{3}{Immutability}
