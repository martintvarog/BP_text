...
\subsubsection{Atestace}

V rámci této práce je atestace chápána jako vyjádření určité skutečnosti ze strany Entity. Podrobnější rozbor datového modelu atestace bude předmětem následujících sekcí práce.
