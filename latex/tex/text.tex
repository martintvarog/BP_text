...
Algoritmus konsenzu je nástroj, který umožňuje uživatelům nebo strojům koordinaci v distribuovaném prostředí. Musí zajistit, že všichni aktéři v systému se mohou shodnout na jednom pravdivém zdroji informací, a to i v případě, že některé části systému selžou. Jinými slovy, systém musí být odolný vůči chybám.[16]
...
\section{Aplikace pro ověřování dokůmentů}
