...
Hlavním cílem praktické části této diplomové práce je navrhnout a implementovat aplikaci, která spojuje robustní funkcionalitu s přívětivým a intuitivním uživatelským rozhraním. Uživatelské rozhraní by mělo být navrženo tak, aby bylo jednoduché a snadno ovladatelné pro širokou škálu uživatelů, bez ohledu na jejich technickou zdatnost.
