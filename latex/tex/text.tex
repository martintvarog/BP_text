...
\obr{Symetrická kryptografie [12]}{fig:logo}{1}{graphics/SymmetricEncrypt.jpg}
...
\obr{Asymetrická kryptografie [12]}{fig:logo}{1}{graphics/AsymmetricEncrypt.jpg}
...
Digitální podpis je kryptografická technika používaná k ověření pravosti zprávy, transakce nebo dokumentu.[13] 

V kontextu blockchainu se digitální podpis používá k prokázání vlastnictví určité transakce nebo dat jednotlivcem nebo entitou.[13]
...
Blockchainová peněženka je speciální softwarové nebo hardwarové zařízení, které se používá k uchování informací o transakcích a osobních informací uživatele. Blockchainové peněženky neobsahují skutečnou měnu. Peněženky se používají k uchování soukromých klíčů a udržování bilance transakcí.[11]
