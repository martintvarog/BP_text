...
\obr{Diagram případu použití Entita}{fig:Entita.UC]}{0.7}{graphics/DiagramPouzitiEntita.png}


\obr{Diagram případu použití Příjemce}{fig:Entita.UC]}{0.7}{graphics/DiagramPouzitiPrijemce.png}

\obr{Diagram případu použití Ověřitel}{fig:Entita.UC]}{0.7}{graphics/DiagramPouzitiOveritel.png}
...
\begin{table}[h]
	...
	\begin{tabular}{|p{1cm}|p{2cm}|p{10cm}|}
		...
		6 & Entita & Potvrdí a zaplatí transakci pomocí Metamask.\\ \hline
		7 & Systém & Zobrazí atestaci a její metadata. \\ \hline
		
		\multicolumn{3}{|l|}{\textbf{Alternativní scénáře:}} \\ \hline
		\multicolumn{3}{|l|}{UC02-6A, UC02-4A} \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}{|p{1cm}|p{2cm}|p{10cm}|}
		\hline
		\multicolumn{3}{|l|}{\textbf{Název:} Alternativní scénář k UC02 - Nevalidní data} \\ \hline
		...
		2 & Entita & Vyplní formulář pro vytvoření atestace znovu. \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}{|p{1cm}|p{2cm}|p{10cm}|}
		\hline
		\multicolumn{3}{|l|}{\textbf{Název:} Alternativní scénář k UC03 - nevalidní id transakce} \\ \hline
		\multicolumn{3}{|l|}{\textbf{ID:} UC03-2A} \\ \hline
		\multicolumn{3}{|l|}{\textbf{Charakteristika:}} \\ \hline
		\multicolumn{3}{|l|}{Systém upozorní na neexistující id transakce v Block chain} \\ \hline
		\multicolumn{3}{|l|}{\textbf{Primární aktér:} Příjemce} \\ \hline
		\multicolumn{3}{|l|}{\textbf{Hlavní scénář:}} \\ \hline
		\textbf{Krok} & \textbf{Aktér} & \textbf{Popis} \\ \hline
