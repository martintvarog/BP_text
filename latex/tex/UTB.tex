...
% PRO KOD
%\usepackage{listings} % Přidání balíčku pro zobrazení kódu
%\usepackage{xcolor} % Přidání balíčku pro možnost použití barev

%\lstset{ % Nastavení vzhledu kódu
%	language=[Sharp]C, % Specifikace jazyka jako C#
%	keywordstyle=\color{blue}, % Nastavení barvy klíčových slov
%	stringstyle=\color{red}, % Nastavení barvy řetězců
%	commentstyle=\color{green}, % Nastavení barvy komentářů
%	morecomment=[l][\color{magenta}]{\#}, % Nastavení barvy direktiv proprocesor
%	frame=single, % Rámeček kolem kódu
%	breaklines=true, % Automatické zalomení dlouhých řádků
%	backgroundcolor=\color{gray!10}, % Toto nastaví mírně šedé pozadí
%}

%\lstdefinelanguage{Solidity}{
%	keywords={struct, bytes32, bool, string},
%	keywordstyle=\color{blue}\bfseries,
%	ndkeywords={contract, public, private, if, return, for},
...
\clearpage
\includepdf[pages=-]{graphics/zadani_A21295_66903.pdf}
\thispagestyle{empty}
}
